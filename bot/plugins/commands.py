...
async def start(bot, update):
                    ...
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '👨‍💼 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛𝚜 👨‍💼', url="https://t.me/joinchat/HKLQU33m1l00NTI9"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        ...
        InlineKeyboardButton('𝗚𝗿𝗼𝘂𝗽', url='https://t.me/Movi_Night'),
        InlineKeyboardButton('𝗖𝗵𝗮𝗻𝗻𝗲𝗹', url='https://t.me/MovieNight124')
    ],[
        InlineKeyboardButton('𝗖𝗵𝗮𝗻𝗻𝗲𝗹', url='https://t.me/MovieNight234')
   ]]
...
async def about(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('𝗚𝗿𝗼𝘂𝗽', url='https://t.me/Movi_Night'),
        InlineKeyboardButton('𝗖𝗵𝗮𝗻𝗻𝗲𝗹', url='https://t.me/joinchat/HKLQU33m1l00NTI9')
    ],[
        InlineKeyboardButton('𝗖𝗵𝗮𝗻𝗻𝗲𝗹', url='https://t.me/MovieNight124)
    ],[
        InlineKeyboardButton('🏠 𝙷𝚘𝚖𝚎', callback_data='start'),
